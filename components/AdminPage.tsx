...
import { Shield, ShieldAlert, User as UserIcon, Search, Filter } from 'lucide-react';
...
const AdminPage: React.FC = () => {
    ...
    const handleRoleChange = async (userId: string, currentRole: 'admin' | 'member') => {
        // Prevent changing own role if critical? Or just allow it. Prompt didn't specify validation.
