        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-bg-card border border-white/10 rounded-3xl p-8 shadow-2xl flex flex-col items-center animate-fade-in overflow-hidden">
                ...
                <button
                    onClick={handleLogin}
                    disabled={loading}
                    className="w-full py-3.5 px-6 bg-white text-gray-900 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed group"
                >
                    {loading ? (
