      ...
      <main className="flex-1 ml-0 md:ml-72 p-4 md:p-8 h-screen overflow-hidden flex flex-col relative z-10">
        ...
        {activeTab === 'dashboard' && selectedProjectId && projects.length > 0 && (
          <button
            ...
            className="fixed bottom-24 right-6 w-14 h-14 bg-primary text-black rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,224,255,0.6)] z-[60] active:scale-95 transition-all md:hidden"
          >
